fission spec init
fission env create --spec --name onb-us-enum-jb-stat-env --image nexus.sigame.com.br/fission-onboarding-us-enum-job-status:0.1.0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
